"""
Django settings for empty_unit_dev_105126 project.
...
ROOT_URLCONF = 'empty_unit_dev_105126.urls'
...
WSGI_APPLICATION = 'empty_unit_dev_105126.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "empty_unit_dev_105126 API",
    "DESCRIPTION": "API documentation for empty_unit_dev_105126 App",
    "VERSION": "v1",
}
